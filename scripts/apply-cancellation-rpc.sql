-- Safe to re-run: updates cancel context RPC only (table/policy already exist).
-- Paste this in Supabase SQL Editor if the full migration fails on duplicate policy.
