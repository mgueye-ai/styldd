...
(function () {
  ...
  var BOOKING_NOTICE_KEY = "salon_site_booking_notice";
  /** Must match js/booking.js — used when the confirmation URL arrives without ?booking_id=. */
  var DETAILS_BOOKING_KEY = "salon_site_details_booking_id";
  var STRIPE_RETURN_BOOKING_KEY = "salon_site_stripe_booking_id";
  ...
  async function downloadPng() {
    ...
    try {
      ...
      a.download = "salon-booking-" + short + ".png";
