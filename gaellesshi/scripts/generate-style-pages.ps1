...
<html lang="en">
  <head>
    ...
    <meta name="description" content="$titleEsc | Hair by Nadjae." />
    <title>$($s.title) | Khady Hair Braiding</title>
    ...
    <header class="site-header">
      <div class="container header-inner">
        <a class="brand-link header-brand" href="index.html">
          <img class="logo-img" src="assets/logo.png" width="72" height="72" alt="Khady Hair Braiding logo" />
          <span class="brand-text">
            <strong>Khady Hair Braiding</strong>
            <span>HairbyNadjae.com</span>
          </span>
        </a>
...
$careLi
    ...
    <footer class="site-footer">
          ...
          <div class="footer-brand">
            <a class="footer-brand__link" href="index.html">
              <img
                ...
                width="80"
                height="80"
                alt="Khady Hair Braiding logo"
                decoding="async"
              />
              <span class="footer-brand__text">
                <span class="footer-brand__name">Khady Hair Braiding</span>
                <span class="footer-brand__tagline">Neat, fast &amp; affordable braids · Flawless styles</span>
                <span class="footer-brand__meta">HairbyNadjae.com</span>
              </span>
            </a>
            <p class="footer-brand__address">By appointment — studio details shared when you book</p>
            <p class="footer-social">
              <a href="https://www.instagram.com/benie.s_hair_braiding" target="_blank" rel="noopener noreferrer">Instagram</a>
              <span class="footer-social__sep" aria-hidden="true">·</span>
              <a href="https://www.facebook.com/BenieHairBraiding/" target="_blank" rel="noopener noreferrer">Facebook</a>
              <span class="footer-social__sep" aria-hidden="true">·</span>
              <a href="https://www.tiktok.com/@benie.s_hair_braiding" target="_blank" rel="noopener noreferrer">TikTok</a>
            </p>
          </div>
          <div class="footer-col">
            <h3 class="footer-heading">Contact</h3>
            <p><a href="tel:+18608227448">(860) 822-7448</a></p>
            <p><a href="mailto:queengaelle492@gmail.com">queengaelle492@gmail.com</a></p>
          </div>
          <div class="footer-col">
      ...
      <div class="container footer-bottom">
        <p>&copy; 2026 Khady Hair Braiding. All rights reserved.</p>
        <p class="footer-built-by">
          <a
            class="footer-built-by__link"
            href="https://hillwebworks.com/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              class="footer-built-by__logo"
              src="assets/hillwebworks-logo.png"
              width="22"
              height="22"
              alt=""
              decoding="async"
            />
            Built by HillWebWorks.com
          </a>
        </p>
      </div>
    </footer>
